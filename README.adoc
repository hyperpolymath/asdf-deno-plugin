...
:url-repo: https://github.com/hyperpolymath/asdf-deno-plugin
...
image:https://img.shields.io/github/license/hyperpolymath/asdf-deno-plugin?style=flat-square[License,link=LICENSE]
image:https://img.shields.io/github/v/release/hyperpolymath/asdf-deno-plugin?style=flat-square[Release,link={url-repo}/releases]
image:https://img.shields.io/github/actions/workflow/status/hyperpolymath/asdf-deno-plugin/ci.yml?branch=main&style=flat-square[Build Status,link={url-repo}/actions]
image:https://img.shields.io/badge/asdf-plugin-blue?style=flat-square[asdf Plugin,link={url-asdf}]

[.lead]
An {url-asdf}[asdf] plugin to install and manage {url-tool}[Deno] versions.
...
Deno is an upstream tool managed by this plugin. Refer to the official
...
|**Version Switching**
|Switch between Deno versions per project

|**Project Isolation**
|Pin Deno per repository via `.tool-versions`

|**Reproducible Builds**
|Align CI/CD and developer environments to the same Deno version
...
=== Installing Deno Versions

[source,bash]
----
asdf list all deno
asdf install deno latest
asdf install deno 0.1.0
----
...
[source,bash]
----
asdf global deno 0.1.0
asdf local deno 0.1.0
asdf current deno
deno --version
----
...
* Ensure `deno` is on PATH after installation.
* Verify the installed version with `deno --version`.
